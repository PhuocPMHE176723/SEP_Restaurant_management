...
public class ReservationServicePostTests
{
    ...
    public async Task UTCID01_CreateReservationAsync_CustomerExists_NoMenuItems_DepositIsMin()
    {
        ...
        var service = new ReservationService(context, mapperMock.Object, new Mock<SEP_Restaurant_management.Core.Services.Interface.INotificationService>().Object, new Mock<SEP_Restaurant_management.Core.Services.Interface.IEmailService>().Object);

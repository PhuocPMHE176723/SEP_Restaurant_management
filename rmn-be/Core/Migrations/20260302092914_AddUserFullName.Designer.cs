...
namespace rmn_be.Core.Migrations
{
    ...
    [Migration("20260302092914_AddUserFullName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.CustomDish", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.CustomDishIngredient", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Customer", b =>
                {
                    ...
                    b.HasKey("CustomerId")
                        .HasName("PK__Customer__A4AE64D83AEFDF51");
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Discount", b =>
                {
                    b.Property<int>("DiscountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Dish", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.DishIngredient", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.ImportBill", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.ImportBillDetail", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.OrderStaff", b =>
                {
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Price", b =>
                {
                    b.Property<int>("PriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Shift", b =>
                {
                    b.Property<int>("ShiftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Staff", b =>
                {
                    ...
                    b.HasKey("StaffId")
                        .HasName("PK__Staff__96D4AB17C0B5976D");
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Table", b =>
                {
                    b.Property<int>("TableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderDiscount", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.Discount", null)
                        .WithMany()
                        .HasForeignKey("DiscountId")
                        .IsRequired()
                        .HasConstraintName("FK_OrderDiscount_Discount");

                    b.HasOne("SEP_Restaurant_management.Core.Models.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderTable", b =>
                {
                    ...
                    b.HasOne("SEP_Restaurant_management.Core.Models.Table", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.CustomDishIngredient", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.CustomDish", "CustomDish")
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Dish", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.Category", "Category")
                        .WithMany("Dishes")
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.ImportBill", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.Staff", "CreateStaff")
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.ImportBillDetail", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.ImportBill", "ImportBill")
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.Order", b =>
                {
                    ...
                    b.HasOne("SEP_Restaurant_management.Core.Models.Shift", "Shift")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SEP_Restaurant_management.Core.Models.OrderDetail", b =>
                {
                    b.HasOne("SEP_Restaurant_management.Core.Models.DishSize", "DishSize")

...
namespace rmn_be.Core.Services.Implementation
{
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<PagedResultDTO<CustomerDTO>> GetAllCustomersAsync(PagingRequestDTO pagingRequest)
        {
            ...
            var orderedCustomers = customers.OrderByDescending(x => x.CreatedAt);

            var totalRecords = orderedCustomers.Count();
        ...
        public async Task<CustomerContextDTO> GetMyContextAsync(string userId)
        {
        ...
        private OrderDTO MapOrderDTO(Order order)
        {
            ...
            .Select(i => new OrderItemDTO
            {
                ...
                MenuItemName = i.ItemNameSnapshot,
                Quantity = i.Quantity,

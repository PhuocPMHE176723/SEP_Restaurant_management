            ...
            {ledgers.length === 0 ? (
              ...
              ledgers.map((l) => (
                <tr key={l.ledgerId}>
                  ...
                  <td>
                    <span
                      className={`${styles.statusBadge} ${l.refType === "INVOICE" ? styles.statusPublished : l.refType === "REDEEM" ? styles.statusPending : styles.statusCancelled}`}
                    >
                      {l.refType}
                    </span>
                  </td>
                  ...
                  <td
                    style={{
                      fontWeight: 600,
                      color: l.pointsChange > 0 ? "#16a34a" : "#dc2626",
                    }}
                  >

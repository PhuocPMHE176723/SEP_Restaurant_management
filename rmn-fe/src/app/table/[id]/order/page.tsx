...
export default function GuestOrderPage() {
  ...
  const handleSubmitOrder = async () => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch(`${apiUrl}/Order/guest-add-items`, {
        method: "POST",
  ...
  if (loading)
    return <div className={styles.loading}>Đang chuẩn bị thực đơn...</div>;
            ...
            <div className={styles.cartFooter}>
              ...
              >
                {submitting ? (
                  ...
                  <>
                    <Send size={20} /> Gửi yêu cầu gọi món
                  </>
                )}
              </button>
            </div>
